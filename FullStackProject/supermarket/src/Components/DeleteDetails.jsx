...
export default function FetchAllProducts() {
    ...
    const handleChangePage = (event, newPage) => {
      ...
      const handleClick = async (pId) => {
        try {
          await axios.delete(`http://localhost:8080/deletedata/${pId}`);
  ...
  return (
    <div className='container' style={{background:'  linear-gradient(to bottom, rgb(201, 255, 191), rgb(255, 175, 189))',height:'99vh',
    marginTop:'0px',
    padding:'5px',
    fontSize:'50px',
        ...
        <Paper style={paperStyle}>
         {/* <TableContainer component={Paper}>  */}
            ...
            <TableHead>
                ...
                <TableCell align="justify" style={tableCellHeadStyle}>Delete</TableCell>
            </TableRow>
            </TableHead>
            <TableBody>
                {
                    tableData.map((ProductDetails,index)=>(
                        <TableRow>
                            ...
                            <TableCell style={tableCellStyle}> 
                                 <Button style={buttonStyles} onClick={()=> handleClick(ProductDetails.pId)}>Delete</Button>
                             </TableCell>
